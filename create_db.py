...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'clamorea', 'email': 'clamorea@umd.edu', 'first_name':'Colin', 'last_name':'LaMoreaux',
            'password': generate_password_hash('clamoreapw', method='pbkdf2:sha256'), 'role':'STUDENT'}
    ]
